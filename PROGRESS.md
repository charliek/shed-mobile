...
- [ ] **M4b:** specialUse foreground service (flutter_foreground_task) hosting/keeping-alive the SSH session; soft-keyboard for xterm; MagicDNS 100.x raw-IP fallback note
